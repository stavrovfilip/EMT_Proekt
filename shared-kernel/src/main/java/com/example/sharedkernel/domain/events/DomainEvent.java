...
public class DomainEvent {
    ...
    /*
    Sekoj event ima topic i datum. Pritoa ovde vrsime i serijalizacija i deserijalizacija vo Json format kako i od Json format
    vo Java klasa, t.e DomainEvent.
     */
